...
EGO_SUM=(
	...
	"github.com/eclipse/paho.mqtt.golang v1.1.1/go.mod"
	...
	"github.com/thedevsaddam/gojsonq v2.3.0+incompatible/go.mod"
...
SRC_URI="
	https://github.com/hikhvar/mqtt2prometheus/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}
"
...
src_compile() {
	go build -o "${PN}" ./cmd || die "go build failed"
}

src_install() {
	DOCS=( *.md examples hack )
	einstalldocs

	dobin "${PN}"

	keepdir /etc/mqtt2prometheus
